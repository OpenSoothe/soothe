...
from soothe.goal_contracts import GoalDispatchContextContribution
...
from soothe_autopilot.verify.consensus import ConsensusResult, ConsensusVerdict
...
class TestNeedsReplanOutcome:
    ...
    def test_build_contribution_passes_effects(self) -> None:
        ...
        contrib = AutopilotSootheRunner._build_contribution(pr, goal_id="g1")
