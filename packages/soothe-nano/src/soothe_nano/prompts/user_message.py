...
from soothe_nano.context_projection import PriorGoalSummary
from soothe_nano.planning_schemas import PlanGapAnalysis

if TYPE_CHECKING:
    from soothe_nano.context_projection import ContextBundle
    from soothe_nano.planning_schemas import PriorProgressDigest
...
class UserMessageBuilder:
    ...
    def build_plan_generate_message(
        ...
        *,
        ...
        from soothe_nano.agent.subagent_catalog import is_intake_only_wire_subagent
