"""Transcript message models for TUI display (runtime source of truth).

Lightweight dataclasses for chat history. DOM virtualization lives in
``soothe_cli.tui.widgets.message_store``.
"""
