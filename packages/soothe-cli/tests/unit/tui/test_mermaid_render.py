...
from soothe_cli.display.markdown_theme import ThemedMarkdownRenderer, build_markdown
from soothe_cli.display.mermaid_render import is_mermaid_lexer, render_mermaid_art
...
def test_render_mermaid_art_exception_returns_none() -> None:
    with patch(
        "soothe_cli.display.mermaid_render._render_plain",
