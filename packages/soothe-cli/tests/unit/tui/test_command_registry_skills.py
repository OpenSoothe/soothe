"""Tests for ``soothe_cli.commands.command_registry`` skill-related functions."""
...
def test_bare_quit_words_are_exact_single_tokens() -> None:
    from soothe_cli.commands.command_registry import ALWAYS_IMMEDIATE, BARE_QUIT_WORDS
