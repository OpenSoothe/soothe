...
from soothe.mcp.auth import interpolate_auth_headers
from soothe.mcp.budget import MCPToolDescriptor
from soothe.mcp.connection import MCPConnection
from soothe.mcp.events import (
    emit_server_connect_failed,
    emit_server_connected,
    emit_server_disconnected,
)
from soothe.mcp.name_utils import build_mcp_tool_name
from soothe.mcp.reconnect import schedule_reconnect
from soothe.mcp.transports import make_connection_spec
...
class MCPRegistry:
    ...
    async def _cleanup_stdio(self, name: str, deadline: float) -> None:
        ...
        from soothe.mcp.cleanup import cleanup_subprocess
    ...
    async def invoke(self, server: str, tool: str, args: dict) -> Any:
        ...
        try:
            ...
            from soothe.mcp.events import emit_tool_invoked
            ...
            from soothe.mcp.events import emit_tool_timeout
    ...
    async def read_resource(self, server: str, uri: str) -> str:
        ...
        try:
            ...
            from soothe.mcp.events import emit_resource_read
