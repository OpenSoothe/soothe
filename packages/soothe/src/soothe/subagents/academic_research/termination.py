"""Early termination logic for Academic Research research loops.
...
from soothe.subagents.academic_research.protocol import SourceResult
...
def should_terminate_early(
    ...
    Args:
        ...
        config: Optional AcademicResearchConfig for thresholds.
