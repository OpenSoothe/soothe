...
_PLAN_RESEARCH = """\
You are a public web research analyst. For the topic below:
1. Identify key sub-questions.
2. Generate targeted web search queries (< 50 chars, same language as topic).
