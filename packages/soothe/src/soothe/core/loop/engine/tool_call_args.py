...
def _predict_unified_id(
    ...
    *,
    ...
    from soothe.core.loop.engine.executor import _unified_tool_call_id_for_stream
...
class ToolCallArgsCollector:
    ...
    def promote_tool_message(
        ...
        *,
        ...
        from soothe.core.loop.engine.executor import _rewrite_tool_message_tool_call_id
