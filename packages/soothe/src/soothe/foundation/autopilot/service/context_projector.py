...
if TYPE_CHECKING:
    ...
    from soothe.foundation.autopilot.service.context_store import GoalDispatchContextStoreProtocol
...
class ContextProjector:
    ...
    def _merge_plan_steps(
        ...
        from soothe.foundation.autopilot.engine.models import PriorStepSummary
    ...
    def _merge_tool_stats(
        ...
        from soothe.foundation.autopilot.engine.models import ToolCallStats
