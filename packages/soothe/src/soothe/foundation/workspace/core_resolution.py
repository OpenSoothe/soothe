...
from soothe.foundation.workspace.stream_resolution import ResolvedWorkspace
...
def _resolve_stream(
    *,
    ...
    from soothe.foundation.workspace.stream_resolution import resolve_workspace_for_stream
