...
from soothe.subagents.academic_research.display_summary import derive_report_title
from soothe.subagents.academic_research.persistence import (
...
def test_save_academic_research_report_writes_workspace_relative_file(tmp_path: Path) -> None:
    from soothe.foundation.workspace.context import set_workspace_context
...
def test_format_saved_report_answer() -> None:
    from soothe.subagents.academic_research.persistence import SavedAcademicResearchReport
