...
from soothe.subagents.academic_research.implementation import create_academic_research_subagent
...
def test_create_academic_research_subagent_name(
    ...
    with patch(
        "soothe.subagents.academic_research.implementation.build_academic_research_engine",
...
def test_create_academic_research_academic_source_only(
    ...
    from soothe.subagents.academic_research.implementation import _build_academic_source
