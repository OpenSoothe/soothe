...
from soothe.subagents.deep_research.implementation import create_deep_research_subagent
...
def test_create_deep_research_subagent_name(mock_model: MagicMock, mock_config: MagicMock) -> None:
    with patch(
        "soothe.subagents.deep_research.implementation.build_deep_research_engine",
...
def test_create_deep_research_web_source_only(
    ...
    from soothe.subagents.deep_research.implementation import _build_web_source
