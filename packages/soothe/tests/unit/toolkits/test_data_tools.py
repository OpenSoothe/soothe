...
class TestDataInspectionTools:
    ...
    def inspect_tool(self):
        ...
        from soothe.toolkits.data import InspectDataTool
...
class TestDataSummaryTools:
    ...
    def summarize_tool(self):
        ...
        from soothe.toolkits.data import SummarizeDataTool
...
class TestDataQualityTools:
    ...
    def quality_tool(self):
        ...
        from soothe.toolkits.data import CheckDataQualityTool
...
class TestDocumentQA:
    ...
    def qa_tool(self):
        ...
        from soothe.toolkits.data import AskAboutFileTool
