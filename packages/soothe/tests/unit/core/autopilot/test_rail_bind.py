...
async def test_submit_auto_pick_binds_llm_rail(
    ...
    from soothe.autopilot.rails.selector import RailAutoPicker, RailAutoPickResponse
...
async def test_spike_pause_resume_user_intervention_and_jsonl_trace(tmp_path: Path) -> None:
    ...
    """
    from soothe.autopilot.rails.guards import ScriptedGuardEvaluator
...
async def test_spike_veritas_auto_proceed_completes_without_resume(tmp_path: Path) -> None:
    ...
    from soothe.autopilot.rails.guards import ScriptedGuardEvaluator
    from soothe.autopilot.rails.interpreter import LoopRailInterpreter
    from soothe.autopilot.rails.pause_clarify import PauseClarifyDecision
    from soothe.autopilot.rails.trace_store import JsonlRailTraceStore
