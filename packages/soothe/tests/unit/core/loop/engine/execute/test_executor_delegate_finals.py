...
async def test_backfill_tool_calls_args_from_chunks_by_index() -> None:
    ...
    from soothe.sloop.engine.execute.executor import _backfill_tool_calls_args_from_chunks
...
async def test_stream_and_collect_logs_tool_call_args_from_index_chunk(
    ...
    caplog.set_level(logging.DEBUG, logger="soothe.sloop.engine.execute.executor")
