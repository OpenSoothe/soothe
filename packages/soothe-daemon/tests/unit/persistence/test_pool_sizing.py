...
def test_recommended_agentloop_pool_size() -> None:
    assert recommended_agentloop_pool_size(max_thread_workers=6) == 8
    assert recommended_agentloop_pool_size(max_thread_workers=30) == 32
