...
from soothe_plugins.paperscout.models import ArxivPaper, ZoteroPaper
from soothe_plugins.paperscout.state import PaperScoutConfig, SmtpConfig, ZoteroConfig
