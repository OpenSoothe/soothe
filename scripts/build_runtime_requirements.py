...
Generates third-party dependency lines from package metadata so Docker can cache
dependency installation independently from source code changes.
"""
...
SKIP_LOCAL = {"soothe", "soothe-sdk", "soothe-daemon", "soothe-cli"}
