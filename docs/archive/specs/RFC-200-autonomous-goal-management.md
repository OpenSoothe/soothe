...
**Archive Reason**: Control flow replaced by autopilot push model; GoalEngine responsibilities updated. Sections on GoalEngine responsibilities, backoff reasoning, and EvidenceBundle remain authoritative.
