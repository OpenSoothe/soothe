...
> The actual wiki structure has diverged from this plan. This document is retained for
> historical reference only. For current documentation, see the [Wiki README](README.md).
>
> ---
...
**Created**: 2026-06-06
**Status**: Archived (Design Proposal — structure does not match current wiki)
...
```
See [API Reference: soothe.foundation.core.agent](../api-reference/python-api/soothe.foundation.core.md).
```
...
- [ContextEngine](./goal-engine.md) - Delegates to StrangeLoop
```
...
| core/context | RFC-200, RFC-204 | RFC-222 |
