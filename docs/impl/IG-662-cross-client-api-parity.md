# IG-662: Cross-Client API Parity (Python Reference)

**Guide**: IG-662  
**Title**: Align Go and TypeScript clients with Python production API semantics  
**Created**: 2026-07-17  
**Status**: Phase A–D complete  
**Related**: RFC-629 (updated), RFC-450, IG-655 (Python extract), IG-660 (TS parity), IG-651 (Go appkit lifecycle)
...
- IG-651 remaining airway thin-down (product Layer 2)
- Desktop rewire to new TS export tiers (IG-650 successor)
