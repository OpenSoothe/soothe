# IG-677: Nano Boundary Push-Down (filesystem → deepagents, skills thin)

**Guide**: IG-677  
**Created**: 2026-07-20  
**Related**: IG-668, AGENTS.md §3/§6, `boundary-fixes.md`, release-soothe skill  
...
- Changelog each package with a short “Breaking (IG-677 cutover)” note listing
...
- **Release cutover**: bump small versions on all affected packages; update
  inter-package pins; changelog “Breaking (IG-677 cutover)” sections; publish
