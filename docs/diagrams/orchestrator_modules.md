...
| `stations.py` | Station IDs + graph channels | live stations, `LoopGraphState`, `PLANNING_LEDGER_PHASES` |
...
| `continuation.py` | Fresh / structural continuation | `is_fresh_goal`, `is_structural_continuation`, `has_prior_goal_context` |
