...
- [`docs/rfc-methodology-guide.md`](../rfc-methodology-guide.md) - Reusable methodology playbook for RFC authoring, lifecycle transitions, and gap triage. **Normative reference** for all RFC update work: consult this guide before authoring or transitioning status.
