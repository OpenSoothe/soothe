...
> **Note**: Skillify, Weaver, and other optional agents are maintained in the [soothe-plugins](https://github.com/mirasoth/soothe-plugins) project. See that repository’s RFC-601 companion doc (IG-415).
