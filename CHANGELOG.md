...
- Add upper caps to previously unbounded deps: `aiohttp<4`, `aiosqlite<1`, `anyio<5`, `pexpect<5`, `requests<3`, `psycopg<4`, `langgraph-checkpoint-postgres<3` (in `soothe`); `fastapi<1`, `psutil<8`, `uvicorn<1` (in `soothe-daemon`); `textual<10`, `rich<15`, `pillow<12`, `websockets<16` (in `soothe-cli`).
